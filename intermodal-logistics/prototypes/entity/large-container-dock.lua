-- local pictures = {
-- 	horizontal = {
-- 		filename = "__intermodal-logistics__/graphics/entity/intermodal-dock/horizontal-large-container-dock.png",
-- 		priority = "very-low",
-- 		width = 256,
-- 		height = 128,
-- 		hr_version =
...
-- 	},
-- 	vertical = {
-- 		filename = "__intermodal-logistics__/graphics/entity/intermodal-dock/vertical-large-container-dock.png",
-- 		priority = "very-low",
-- 		width = 128,
-- 		height = 256,
-- 		hr_version =
...
-- local icon_size = 32;
-- local icon = "__intermodal-logistics__/graphics/icon/large-container-dock.png";
