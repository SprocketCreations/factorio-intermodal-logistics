local bogey_north_picture = {
	filename = "__intermodal-logistics__/graphics/entity/small-gantry/bogey-north.png",
	size = { 352, 164 },
	scale = 1,
	shift = { 0.0, -2.277687221765518 },
};
local bogey_east_picture = {
	filename = "__intermodal-logistics__/graphics/entity/small-gantry/bogey-east.png",
	size = { 64, 368 },
	scale = 1,
...
local small_gantry = {
	...
	name = "intermodal-logistics-small-gantry",
	-- Icons
	...
	rotations = {
		...
		north = {
			-- Array of ground contact bogies.
			bogies = {
				{
					bogey = bogey,
			...
			pictures = {
				filename = "__intermodal-logistics__/graphics/entity/small-gantry/north.png",
				size = { 320, 512 },
				scale = 1,
		...
		east = {
			...
			drawing_box = { { -5, -4 }, { 7, 4 } },
			pictures = {
				filename = "__intermodal-logistics__/graphics/entity/small-gantry/east.png",
				size = { 672, 280 },
				scale = 1,
		...
		south = {
			...
			drawing_box = { { -4, -5 }, { 4, 7 } },
			pictures = {
				filename = "__intermodal-logistics__/graphics/entity/small-gantry/south.png",
				size = { 320, 512 },
				scale = 1,
		...
		west = {
			...
			drawing_box = { { -5, -4 }, { 7, 4 } },
			pictures = {
				filename = "__intermodal-logistics__/graphics/entity/small-gantry/west.png",
				size = { 672, 280 },
				scale = 1,
