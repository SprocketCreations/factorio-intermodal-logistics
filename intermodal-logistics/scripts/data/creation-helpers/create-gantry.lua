...
function create_gantry(gantry_data)
	...
	local names = { gantry_data.name .. "-north", gantry_data.name .. "-east", gantry_data.name .. "-south",
		gantry_data.name .. "-west" };
	for i = 1, 4, 1 do
		...
		if (gantry_direction_data ~= nil) then
			local gantry = {
				...
				allow_run_time_change_of_is_military_target = gantry_data.allow_run_time_change_of_is_military_target or
				false,
				...
				subgroup = gantry_data.subgroup or "intermodal-logistics-gantry",
