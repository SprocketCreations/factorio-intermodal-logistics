...
-- is the same
function conditionals:do_all_operators_match()
...
function conditionals:add_time_elapsed_condition(duration)
...
function conditionals:add_inactivity_condition(duration)
	self:add_operator("or");
	self.conditions.insert{
		type = "inactivity",
		time = 5,
...
function conditionals:add_full_condition()
	self:add_operator("or");
	self.conditions.insert{
		type = "full-cargo",
		meets_condition = function(self, entity)
...
function conditionals:add_empty_condition()
	self:add_operator("or");
	self.conditions.insert{
		type = "empty-cargo",
		meets_condition = function(self, entity)
...
function conditionals:add_item_count_condition(constant)
	self:add_operator("or");
	self.conditions.insert{
		type = "item-count",
		left_item = "",
...
function conditionals:add_circuit_condition(constant)
	self:add_operator("or");
	self.conditions.insert{
...
function conditionals:add_operator(operator_type)
...
function conditionals:meets_conditions(entity)
